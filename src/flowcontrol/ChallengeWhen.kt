...
fun main(args: Array<String>) {
     ...
     */
    val myPair = Pair("Luiz", 29)
    when(myPair.second) {
        in 0..2 -> println("${myPair.first} Infant")
        in 3..12 -> println("${myPair.first} Child")
        in 13..19 -> println("${myPair.first} Teenager")
        in 20..39 -> println("${myPair.first} Adult")
        in 40..60 -> println("${myPair.first} Middle aged")
        else -> println("${myPair.first} Elderly")
    }
     ...
     */
    when(myPair.second) {
        in 0..2 -> println("${myPair.first} - ${myPair.second} Infant")
        in 3..12 -> println("${myPair.first} - ${myPair.second} Child")
        in 13..19 -> println("${myPair.first} - ${myPair.second} Teenager")
        in 20..39 -> println("${myPair.first} - ${myPair.second} Adult")
        in 40..60 -> println("${myPair.first} - ${myPair.second} Middle aged")
        else -> println("${myPair.first} - ${myPair.second} Elderly")
    }
}